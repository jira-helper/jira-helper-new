...
var once = require('@tinkoff/utils/function/once');
...
class Context {
    ...
    setState(stateOrFunc) {
        const newState = applyOrReturn__default["default"]([this.state], stateOrFunc);
        if (newState) {
            this.state = {
                ...this.state,
                ...newState,
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            const traversePlugins = (event, direction) => {
                ...
                const next = (newState) => {
                    ...
                    if (!pluginAction || !applyOrReturn__default["default"]([context], propOr__default["default"]('shouldExecute', true, plugin))) {
                        return next();
                    }
                    try {
                        pluginAction(context, once__default["default"](next), makeRequest);
                    }
                    catch (err) {
