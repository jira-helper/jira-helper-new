...
var propApply = require('./propApply');
 ...
 */
module.exports = curryN(3, function (prop, fn, obj) {
  var _objectSpread2;
  ...
  var res = propApply(prop, fn, obj);

  if (has(prop, obj) && obj[prop] === res) {
    return obj;
  }

  return _objectSpread(_objectSpread({}, obj), {}, (_objectSpread2 = {}, _objectSpread2[prop] = res, _objectSpread2));
});